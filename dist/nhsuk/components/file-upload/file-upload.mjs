...
class FileUpload extends ConfigurableComponent {
  ...
  constructor($root, config = {}) {
    ...
    containerSpan.className = 'nhsuk-file-upload-button__pseudo-button-container';
    const buttonSpan = document.createElement('span');
    buttonSpan.className = 'nhsuk-button nhsuk-button--secondary nhsuk-file-upload-button__pseudo-button';
    ...
    instructionSpan.className = 'nhsuk-body nhsuk-file-upload-button__instruction';
    ...
    if (event.target instanceof Node) {
      if (this.$root.contains(event.target)) {
        if (event.dataTransfer && isContainingFiles(event.dataTransfer)) {
          ...
          if (!this.$button.classList.contains('nhsuk-file-upload-button--dragging')) {
  ...
  updateDisabledState() {
    ...
    this.$root.classList.toggle('nhsuk-drop-zone--disabled', this.$button.disabled);
  }
